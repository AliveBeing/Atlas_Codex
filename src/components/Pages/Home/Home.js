              ...
              <ul className="navbar-nav justify-content-center align-items-center fs-5 flex-grow-1 pe-3">
                ...
                <li className="nav-item dropdown mx-2">
                  ...
                  <ul className="dropdown-menu dropdown-menu-dark bg-yellow">
                    <li><Link  to="/Home/History" className='drop'><a className="dropdown-item" href="/#">History</a></Link></li>
                    <li><Link  to="/Home/Lessons" className='drop'><a className="dropdown-item" href="/#">Lessons</a></Link></li>
                    <li><Link  to="/Home/QuizTopics" className='drop'><a className="dropdown-item" href="/#">Quiz</a></Link></li>
                    <li><Link  to="/Home/LatestNews" className='drop'><a className="dropdown-item" href="/#">Latest News & <br/>Updates<img src={icon} alt="new-icon" className="new-icon"/></a></Link></li>
                  </ul>
                </li>
              </ul>
